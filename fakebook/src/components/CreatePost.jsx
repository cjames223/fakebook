            ...
            <div className='create-post-modal'>
                ...
                <div ref={regRefImg}className='photo-upload-container'>
                    ...
                    <div className="photo-upload">
                        <FileUpload ref={fileUploadRef} name="demo[]" url="https://primefaces.org/primereact/showcase/upload.php" multiple accept="image/*" maxFileSize={10000000}
                ...
                <div className='add-to-post-container'>
                    <div>
                        <Button label='Post' className='p-button-raised post-button'/>
                    </div>
                    <div>
